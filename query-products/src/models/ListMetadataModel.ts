...
export interface ListMetadataModelType
  extends Instance<typeof ListMetadataModel.Type> {}

/* A graphql query fragment builders for ListMetadataModel */
export {
  selectFromListMetadata,
 ...
 * ListMetadataModel
 */
export const ListMetadataModel = ListMetadataModelBase.actions((self) => ({
